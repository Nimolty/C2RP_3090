...
def overlay_detected_points_on_image(
    image_input,
    image_points,
    ...
    for idx_point in range(n_image_points):
        ...
        point_left = (point_fixedpt[0]-2, point_fixedpt[1])
        point_right = (point_fixedpt[0]+2, point_fixedpt[1])
        point_up = (point_fixedpt[0], point_fixedpt[1]+2)
        point_down = (point_fixedpt[0], point_fixedpt[1]-2)

        point_radius = point_diameters[idx_point] / 2.0
        radius_fixedpt = int(point_radius * factor / 2) 
...
#    print(belief_map_to_proc.shape)
#    print(torch.where(belief_map_to_proc != 0))

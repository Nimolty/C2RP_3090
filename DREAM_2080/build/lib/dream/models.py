...
from dream.spatial_softmax import SoftArgmax
...
class DreamHourglass(nn.Module):
    def __init__(
        ...
        self.skip_connections = skip_connections
        self.deconv_decoder = deconv_decoder
        print('deconv_decoder', self.deconv_decoder)
        self.full_output = full_output
        self.monte_carlo_pose_loss = MonteCarloPoseLoss()
...
#        )
    ...
    def forward(self, x):
        ...
        # print(x.shape,x_0_1.shape,x_0_1_d.shape,x_0_2.shape,x_0_2_d.shape,x_0_3.shape,x_0_3_d.shape,x_0_4.shape,x_0_4_d.shape,x_0_5.shape,self.full_output)
        #print('skip_connections:', self.skip_connections)
        ...
        if self.deconv_decoder:
            ...
            output_head_0 = self.heads_0(y_0_out)
#            output_head = self.heads_0(y_0_out)
#            bs, _, H, W = output_head.shape
...
#            output_head_0 = output_head[:, :, 0, :, :] #16x7x100x100
        ...
        if 1:
            ...
            outputs.append(softmax_output)#x2d
            
        outputs.append(output_w2d)#w2d
...
#        print(outputs[-1].shape)
        ...
        #         y_0_out = self.upsample_0_1(y_0_out)
        #
        #     output_head_00 = self.heads_0(y_0_out)
        #
        #     output_head_02 = self.heads_2(decoder_input)
        #     output_head_0_1d = torch.flatten(output_head_02,2)
        #     output_head_01 = self.heads_mlp1(output_head_0_1d)
        #     # print(y_0_5.shape, y_0_out.shape,output_head_0.shape)
        #         # y_1_out = self.heads_1(decoder_input)
        #         # y_1_out_1d = torch.flatten(y_1_out,2)
        #         # output_head_1 = self.heads_mlp(y_1_out_1d)
        #     # print(output_head_01.shape,output_head_1.shape)
        #     # print(y_1_out_1d.shape,output_head_1.shape)
        # # Output heads
        # outputs = []
        # outputs.append(output_head_00)
        # outputs.append(output_head_01)
        #
        #
        # # Spatial softmax output of belief map
        # # if 1:
        #     # softmax_output = self.softmax(output_head_00)
        #     # outputs.append(softmax_output)
        #
        # # outputs.append(output_head_1)
        # # Return outputs
        # return outputs

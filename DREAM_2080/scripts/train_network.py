...
def train_network(args):
    ...
    for e in tqdm(range(start_epoch, args.epochs)):
        ...
        for batch_idx, sample in enumerate(tqdm(train_data_loader)):
            ...
            writer.add_scalar('train_loss', loss, batch_idx + e * len(train_data_loader))
            writer.add_scalar('loss_1', loss_1, batch_idx + e * len(train_data_loader))
            writer.add_scalar('loss_2', loss_2, batch_idx + e * len(train_data_loader))
            writer.add_scalar('loss_mc', loss_mc, batch_idx + e * len(train_data_loader))
            writer.add_scalar('loss_t', loss_t, batch_idx + e * len(train_data_loader))
            writer.add_scalar('loss_r', loss_r, batch_idx + e * len(train_data_loader))
